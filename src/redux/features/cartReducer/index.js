...
const calculateExpressCheckoutThread = createAsyncThunk(
    ...
    async (data, {rejectWithValue}) => {
        try{
            ...
            const response = await axios.patch(`${Config.baseUrl}/${Api.calculate_express_checkout}`,
            data,
            {
                headers: {  
                    ...Config.appHeaders,
...
export const cartSlice = createSlice({
    ...
    extraReducers:(builder) =>{
        builder.addCase(calculateExpressCheckoutThread.fulfilled, (state, { payload }) => {
        ...
        builder.addCase(calculateExpressCheckoutThread.rejected, (state, { payload }) => {
