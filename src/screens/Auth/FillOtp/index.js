...
const FillOTP = ({route, navigation}) => {
    ...
    // let emailParam="soniaarora@yopmail.com";
                        ...
                        {({ handleChange, handleBlur, handleSubmit, setFieldValue, setFieldTouched, values, errors, touched }) => (
                            <ScrollView style={styles.scrolViewWrapper}>
                                ...
                                <View style={styles.loginContainer}>
                                    <Text style={styles.usernameText}>Hello Username, Welcome to Netcarbons!</Text>
                                    {emailParam !=undefined &&
                                        <View style={styles.rowWrap}>
                                            <Text style={styles.contentLightText}>Help us secure your account by verifying that </Text><Text style={styles.contentDarkText}>{emailParam} </Text><Text style={styles.contentLightText}>is your email.</Text>
                                        </View>
                                    }

                                    <View style={{marginTop:20, marginBottom:20}}>
                                        <Text style={styles.contentLightText}>Please enter the six-digit code we have sent you in an email, to verify and activate your account</Text>
                                    </View>
                                    ...
                                    <View style={styles.requestNewCodeWrapper}>
                                        <View style={styles.requestNewWrap}>
                                            <Text style={styles.contentLightText}>You can request new code in:</Text>
                                ...
                                <View style={[styles.requestNewCodeWrapper, {marginTop:20, marginBottom:10}]}>
                                    <View style={styles.requestNewWrap}>
